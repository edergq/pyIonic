(function () {
  ...
  (self["webpackChunkSalon"] = self["webpackChunkSalon"] || []).push([["src_app_contactus_contactus_module_ts"], {
    /***/
    38463: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    58037: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    38188: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _ContactusPage = /*#__PURE__*/function () {
        function ContactusPage(menuCtrl, apiService, basic, localApi, route, alertController, location, modalController, activatedRoute, platform, iab, callNumber, emailComposer) {
        ...
        _createClass(ContactusPage, [{
          ...
          key: "acnfr",
          value: function acnfr(frwht, val) {
            this.ipbroptions = {
              location: 'no',
              hardwareback: 'yes',
            ...
            if (frwht == 'address') {
              if (this.platform.is('android')) {
                var browser = this.iab.create('geo:0,0?q=' + val, '_system', this.ipbroptions);
              } else {
                var _browser = this.iab.create('maps://?q=' + val, '_system', this.ipbroptions);
              }
            }

            if (frwht == 'website') {
              var _browser2 = this.iab.create(val, '_blank', this.ipbroptions);
            }

            if (frwht == 'whatsapp') {
              var _browser3 = this.iab.create('https://api.whatsapp.com/send?phone=' + _environments_environment__WEBPACK_IMPORTED_MODULE_5__.environment.mobileprefix + val, '_system', this.ipbroptions);
            }
      ...
      _ContactusPage = (0, tslib__WEBPACK_IMPORTED_MODULE_12__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_13__.Component)({
    ...
    /***/
    43031: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
