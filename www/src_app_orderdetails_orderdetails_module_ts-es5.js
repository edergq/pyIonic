(function () {
  ...
  (self["webpackChunkSalon"] = self["webpackChunkSalon"] || []).push([["src_app_orderdetails_orderdetails_module_ts"], {
    /***/
    2710: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    81195: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    76267: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _OrderdetailsPage = /*#__PURE__*/function () {
        function OrderdetailsPage(menuCtrl, apiService, basic, localApi, cart, route, alertController, modalController, activatedRoute) {
        ...
        _createClass(OrderdetailsPage, [{
          ...
          value: function ionViewWillEnter() {
            ...
            this.apiService.postdata('getorderdetails', this.ordlr).subscribe(function (resp) {
              console.log('User', resp);
              _this.ordltls = resp.data;

              if (_this.ordltls.order_type == 'Delivery') {
                if (_this.ordltls.delivery_cost > 0) {
                  _this.del_sct = _this.getappsetng.currency_symbol + _this.ordltls.delivery_cost;
                } else {
                  _this.del_sct = 'FREE';
                }
              } else {
              ...
              if (_this.ordltls.usewallet == 'YES') {
                if (_this.ordltls.pay_amount_wallet_use == '0.00') {
                  _this.iswaltpayamount = 'FREE';
                } else {
                  _this.iswaltpayamount = _this.getappsetng.currency_symbol + _this.ordltls.pay_amount_wallet_use;
                }
              }
      ...
      _OrderdetailsPage = (0, tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
    ...
    /***/
    51125: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=src_app_orderdetails_orderdetails_module_ts-es5.js.map