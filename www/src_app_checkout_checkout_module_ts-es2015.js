...
let CheckoutPage = class CheckoutPage {
    constructor(menuCtrl, apiService, basic, localApi, cart, route, alertController, location, modalController, activatedRoute, actionSheetController, iab, platform) {
    ...
    openpayform(payby) {
        ...
        const browser = this.iab.create(_environments_environment__WEBPACK_IMPORTED_MODULE_7__.environment.baseurl + 'restapi/stripe_payment/' + this.pay_amount + '/' + this.logedUser.email, '_blank', this.ipbroptions);
    ...
    unpaidorder(payby) {
        ...
        this.apiService.postdata('placemyorderunpaid', this.ordervalue).subscribe((resp) => {
    ...
    paymentaccepted(payby) {
        ...
        this.basic.presentLoading();
        this.apiService.postdata('placemyorder', this.ordervalue).subscribe((resp) => {
...
//# sourceMappingURL=src_app_checkout_checkout_module_ts-es2015.js.map