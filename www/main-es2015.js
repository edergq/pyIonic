...
/***/ 92306:
/*!**************************************************!*\
  !*** ./src/Providers/Basic/basic-api.service.ts ***!
  \**************************************************/
...
/* harmony export */   "BasicApiService": function() { return /* binding */ BasicApiService; }
/* harmony export */ });
...
let BasicApiService = class BasicApiService {
    constructor(toastController, loadingController, alertController) {
    ...
    dismissloader() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return yield this.loadingController.dismiss().then(() => console.log('dismissed this loading'));
        });
    }
    alert(head, msg) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
...
BasicApiService.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__.ToastController },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__.LoadingController },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__.AlertController }
];
BasicApiService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
/***/ 65248:
/*!************************************************!*\
  !*** ./src/Providers/Cart/cart-api.service.ts ***!
  \************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CartApiService": function() { return /* binding */ CartApiService; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 64762);
...
let CartApiService = class CartApiService {
    constructor() {
        let mycrt = JSON.parse(localStorage.getItem(_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.storage_prefix + 'cartlist'));
        if (!mycrt) {
    ...
    addcart(item, variation, selections, mealdeal) {
        ...
        let item_sub_total = parseFloat(itmOnly) + parseFloat(slcTotal) + parseFloat(mldlTotal);
    ...
    plusqnty(item) {
        ...
        let item_sub_total = parseFloat(totalpriceincr) + parseFloat(slcTotal) + parseFloat(mldlTotal);
    ...
    getTotalCart() {
        ...
        this.forcrtttl = 0;
        for (let i = 0; i < cart.length; i++) {
            let total = parseFloat(cart[i].item_sub_total);
            this.forcrtttl = parseFloat(total) + parseFloat(this.forcrtttl);
        }
        return this.forcrtttl.toFixed(2);
    }
};
CartApiService.ctorParameters = () => [];
CartApiService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
/***/ 99068:
/*!**************************************************!*\
  !*** ./src/Providers/Local/local-api.service.ts ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LocalApiService": function() { return /* binding */ LocalApiService; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../environments/environment */ 92340);
...
let LocalApiService = class LocalApiService {
    constructor() {
        let dirymtl = JSON.parse(localStorage.getItem(_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.storage_prefix + 'setngpushface'));
        if (!dirymtl) {
            let psfc = {
                push: true,
                face: false,
...
LocalApiService.ctorParameters = () => [];
LocalApiService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.Injectable)({
        providedIn: 'root'
    })
], LocalApiService);
...
/***/ 48158:
/*!***********************************************!*\
  !*** ./src/Providers/Services/api.service.ts ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _Local_local_api_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Local/local-api.service */ 99068);
...
let ApiService = class ApiService {
    constructor(http, localapiservice) {
        this.http = http;
    ...
    postdata(url, postParams) {
        this.token = 'OK';
        return this.http.post(this.baseurl + url, postParams, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpHeaders({ Authorization: this.token })
        });
    }
    getdata(url, token = null) {
        this.token = token;
        return this.http.get(this.baseurl + url, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpHeaders({ Authorization: this.token })
        });
    }
};
...
const routes = [
    ...
    {
        path: 'homepage',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_jquery_dist_jquery_js"), __webpack_require__.e("common"), __webpack_require__.e("src_app_homepage_homepage_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./homepage/homepage.module */ 42173)).then(m => m.HomepagePageModule)
    },
    {
        path: 'homepage1',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_jquery_dist_jquery_js"), __webpack_require__.e("common"), __webpack_require__.e("src_app_homepage1_homepage_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./homepage1/homepage.module */ 1612)).then(m => m.HomepagePageModule)
    },
    {
        path: 'homepage2',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_jquery_dist_jquery_js"), __webpack_require__.e("common"), __webpack_require__.e("src_app_homepage2_homepage_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./homepage2/homepage.module */ 83734)).then(m => m.HomepagePageModule)
    },
    {
        path: 'homepage3',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_jquery_dist_jquery_js"), __webpack_require__.e("common"), __webpack_require__.e("src_app_homepage3_homepage_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./homepage3/homepage.module */ 60933)).then(m => m.HomepagePageModule)
    },
    {
        path: 'homepage4',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_jquery_dist_jquery_js"), __webpack_require__.e("common"), __webpack_require__.e("src_app_homepage4_homepage_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./homepage4/homepage.module */ 76396)).then(m => m.HomepagePageModule)
    },
    {
        path: 'homepage5',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_jquery_dist_jquery_js"), __webpack_require__.e("common"), __webpack_require__.e("src_app_homepage5_homepage_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./homepage5/homepage.module */ 90399)).then(m => m.HomepagePageModule)
    },
    {
        path: 'homepage6',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_jquery_dist_jquery_js"), __webpack_require__.e("common"), __webpack_require__.e("src_app_homepage6_homepage_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./homepage6/homepage.module */ 86756)).then(m => m.HomepagePageModule)
    },
    {
        path: 'homepage7',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_jquery_dist_jquery_js"), __webpack_require__.e("common"), __webpack_require__.e("src_app_homepage7_homepage_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./homepage7/homepage.module */ 51042)).then(m => m.HomepagePageModule)
    },
    {
        path: 'homepage8',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_jquery_dist_jquery_js"), __webpack_require__.e("common"), __webpack_require__.e("src_app_homepage8_homepage_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./homepage8/homepage.module */ 67202)).then(m => m.HomepagePageModule)
    },
    {
        path: 'loginpage',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_loginpage_loginpage_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./loginpage/loginpage.module */ 38828)).then(m => m.LoginpagePageModule)
    },
    {
        path: 'ourstylists',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_ourstylists_ourstylists_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./ourstylists/ourstylists.module */ 7588)).then(m => m.OurstylistsPageModule)
    },
    {
        path: 'imagegallerypage/:pgtype',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_imagegallerypage_imagegallerypage_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./imagegallerypage/imagegallerypage.module */ 31165)).then(m => m.ImagegallerypagePageModule)
    },
    {
        path: 'aboutus/:pgtype',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_aboutus_aboutus_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./aboutus/aboutus.module */ 76202)).then(m => m.AboutusPageModule)
    },
    {
        path: 'reviewandrating',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_reviewandrating_reviewandrating_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./reviewandrating/reviewandrating.module */ 21646)).then(m => m.ReviewandratingPageModule)
    },
    {
        path: 'openinghours',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_openinghours_openinghours_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./openinghours/openinghours.module */ 16059)).then(m => m.OpeninghoursPageModule)
    },
    {
        path: 'offer/:pgtype',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_offer_offer_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./offer/offer.module */ 61357)).then(m => m.OfferPageModule)
    },
    {
        path: 'listviews/:pgtype',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_listviews_listviews_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./listviews/listviews.module */ 36295)).then(m => m.ListviewsPageModule)
    },
    {
        path: 'ourteam/:pgtype',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_ourteam_ourteam_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./ourteam/ourteam.module */ 16962)).then(m => m.OurteamPageModule)
    },
    {
        path: 'contactus',
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_subcategory_subcategory_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./subcategory/subcategory.module */ 36884)).then(m => m.SubcategoryPageModule)
    },
    {
        path: 'products/:category/:subcategory/:title',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_jquery_dist_jquery_js"), __webpack_require__.e("common"), __webpack_require__.e("src_app_products_products_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./products/products.module */ 88980)).then(m => m.ProductsPageModule)
    },
    {
        path: 'itemdetails',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_itemdetails_itemdetails_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./itemdetails/itemdetails.module */ 55445)).then(m => m.ItemdetailsPageModule)
    },
    {
        path: 'offerdetails',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_offerdetails_offerdetails_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./offerdetails/offerdetails.module */ 95190)).then(m => m.OfferdetailsPageModule)
    },
    {
        path: 'myaccount/:status',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_myaccount_myaccount_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./myaccount/myaccount.module */ 48498)).then(m => m.MyaccountPageModule)
    },
    {
        path: 'profileupdate',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_profileupdate_profileupdate_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./profileupdate/profileupdate.module */ 60149)).then(m => m.ProfileupdatePageModule)
    },
    {
        path: 'booknow',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_jquery_dist_jquery_js"), __webpack_require__.e("src_app_booknow_booknow_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./booknow/booknow.module */ 78534)).then(m => m.BooknowPageModule)
    },
    {
        path: 'mybooking',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_mybooking_mybooking_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./mybooking/mybooking.module */ 24096)).then(m => m.MybookingPageModule)
    },
    {
        path: 'checkout',
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_videogallery_videogallery_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./videogallery/videogallery.module */ 42091)).then(m => m.VideogalleryPageModule)
    },
    {
        path: 'writereview',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_writereview_writereview_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./writereview/writereview.module */ 7037)).then(m => m.WritereviewPageModule)
    },
    {
        path: 'orderdetails/:orderid/:pagetype',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_orderdetails_orderdetails_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./orderdetails/orderdetails.module */ 81195)).then(m => m.OrderdetailsPageModule)
    }
];
...
/* harmony import */ var _loginpage_loginpage_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./loginpage/loginpage.page */ 42985);
/* harmony import */ var _ionic_native_onesignal_ngx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic-native/onesignal/ngx */ 61779);
...
let AppComponent = class AppComponent {
    constructor(platform, route, apiService, localApi, menu, modalController, oneSignal) {
    ...
    initializeApp() {
        ...
        this.platform.ready().then(() => {
            this.oneSignal.startInit(_environments_environment__WEBPACK_IMPORTED_MODULE_6__.environment.onesignalkey, _environments_environment__WEBPACK_IMPORTED_MODULE_6__.environment.firebasekey);
    ...
    setUserTokens(mytoken) {
        ...
        this.apiService.postdata('setusertokens', this.postdata).subscribe((resp) => {
...
/* harmony import */ var _ionic_native_touch_id_ngx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ionic-native/touch-id/ngx */ 5945);
/* harmony import */ var _ionic_native_keyboard_ngx__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @ionic-native/keyboard/ngx */ 4329);
/* harmony import */ var _ionic_native_youtube_video_player_ngx__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @ionic-native/youtube-video-player/ngx */ 64542);
/* harmony import */ var _ionic_native_onesignal_ngx__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ionic-native/onesignal/ngx */ 61779);
...
/***/ 42985:
/*!*********************************************!*\
  !*** ./src/app/loginpage/loginpage.page.ts ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _raw_loader_loginpage_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./loginpage.page.html */ 54201);
/* harmony import */ var _loginpage_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./loginpage.page.scss */ 39316);
...
let LoginpagePage = class LoginpagePage {
    constructor(menuCtrl, apiService, basic, localApi, cart, route, alertController, location, modalController, activatedRoute, platform, touchId) {
    ...
    checkMobile() {
        ...
        if (!this.logmobile) {
            ...
            this.apiService.postdata('checllogin', this.postdata).subscribe((resp) => {
                if (resp.data == false) {
                    this.isnewUser = true;
                }
                else {
    ...
    loginnow() {
        if (!this.logedpass) {
            ...
            this.apiService.postdata('login', this.postdata).subscribe((resp) => {
                if (resp.data == false) {
    ...
    setUserTokens() {
        ...
        this.apiService.postdata('setusertokens', this.tknsvdata).subscribe((resp) => {
            console.log('Set Token', resp);
        }, (err) => {
            return false;
        });
    ...
    signupnow() {
        ...
        if (!this.regt.fullname) {
            ...
            this.apiService.postdata('signup', this.postdata).subscribe((resp) => {
    ...
    forgotpassword() {
        ...
        this.basic.presentLoading();
        this.apiService.postdata('forgotpassword', this.logmobile).subscribe((resp) => {
...
LoginpagePage = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([
...
/***/ 39316:
/*!***********************************************!*\
  !*** ./src/app/loginpage/loginpage.page.scss ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ 54201:
/*!*************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/loginpage/loginpage.page.html ***!
  \*************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
